...
export const enUS = {
  ...
  'menu.migration': 'Migration Center',
  ...
  'menu.desc.migration': 'Append-only Skill / Wiki / Code Graph migration',
  ...
  'common.save': 'Save',
  'common.close': 'Close',
  'wiki.documents.noPending': 'No documents need analysis. Confirm pending deletion cleanup separately in Original documents.',
  ...
  // ===== Migration Center =====
  'migration.title': 'Runtime Data Migration',
  'migration.subtitle': 'Target team: {{team}}',
  'migration.scopeNotice': 'Only Skills, Wikis, and Code Graphs are migrated. Imports always create new IDs and copies; Agents, Agent memory, Chat Memory, Tasks, and asset bindings are excluded.',
  'migration.noTeam': 'Select a team first.',
  'migration.export.title': 'Export selected objects',
  'migration.export.desc': 'Only assets you can read are shown.',
  'migration.export.button': 'Export ({{count}})',
  'migration.export.success': 'Exported {{count}} objects',
  'migration.catalog.empty': 'This team has no exportable Skills, Wikis, or Code Graphs.',
  'migration.import.title': 'Append import',
  'migration.import.desc': 'The ZIP manifest is read locally for preflight, then objects are appended one by one. Duplicate Wiki / Code Graph names use “（导入 N）”; Skills use the portable “-import-N” suffix.',
  'migration.import.choose': 'Choose ZIP',
  'migration.import.file': 'File',
  'migration.import.reselect': 'The server upload was removed; choose the ZIP again to retry',
  'migration.import.empty': 'Choose a migration ZIP to preview its manifest.',
  'migration.import.button': 'Append import ({{count}})',
  'migration.import.success': 'Imported {{count}} objects',
  'migration.import.partial': 'Import completed with some failures. See the report.',
  'migration.packageFailures': '{{count}} other objects failed during the original export and are not present in this package.',
  'migration.job.title': 'Import job',
  'migration.job.imported': 'imported',
  'migration.job.failed': 'failed',
  'migration.report.title': 'Import report',
  'migration.retry': 'Retry failed objects',
  'migration.retryNotice': 'Retries never reuse the server upload. Choose the original ZIP again; successful objects will not be imported again.',
  ...
  'wiki.status.updating': 'Updating',
  'wiki.status.updateFailed': 'Update failed',
  ...
  'wiki.analysis.title': '{{name}} · AI analysis',
  'wiki.analysis.progressTitle': 'AI analysis progress',
  'wiki.analysis.documentCount': '{{done}} / {{total}} documents',
  'wiki.analysis.completedCount': 'Completed',
  'wiki.analysis.failedCount': 'Failed',
  'wiki.analysis.remainingCount': 'Remaining',
  'wiki.analysis.skippedCount': 'Skipped',
  'wiki.analysis.cachedCount': 'Checkpoints reused',
  'wiki.analysis.currentFiles': 'Currently processing ({{count}})',
  'wiki.analysis.updatedAt': 'Progress updated at {{time}}',
  'wiki.analysis.waitingProgress': 'Loading detailed analysis progress…',
  'wiki.analysis.failedState': 'AI analysis failed',
  'wiki.analysis.pause': 'Pause AI analysis',
  'wiki.analysis.resume': 'Resume AI analysis',
  'wiki.analysis.syncLatest': 'Sync and analyze latest documents',
  'wiki.analysis.complete': 'AI analysis completed',
  'wiki.analysis.pausing': 'Pausing AI analysis…',
  'wiki.analysis.paused': 'Analysis paused',
  'wiki.analysis.pausedHint': 'Analysis paused. Completed AI results are saved. Resume to continue processing.',
  'wiki.analysis.progress': 'Documents {{total}} · Completed {{completed}} · Failed {{failed}} · Skipped {{skipped}} · Checkpoints reused {{cached}}',
  'wiki.analysis.phase.extracting': 'AI is analyzing source documents',
  'wiki.analysis.phase.merging': 'Merging knowledge pages',
  'wiki.analysis.phase.indexing': 'Building indexes and publishing the version',
  'wiki.version.state.paused': 'Paused',
  'wiki.git.source': 'Document source',
  'wiki.documents.title': "Source documents",
  'wiki.documents.batchSelection': 'Batch selection: {{count}} sources · {{cleanup}} confirmed deletions',
  'wiki.documents.replaceTask': 'An unfinished selection task exists. Replace it with this selection?',
  'wiki.documents.hint': "Documents are unselected by default. Analysis processes only selected documents and preserves other knowledge. Deleted documents require separate cleanup confirmation.",
  'wiki.documents.overall': "Whole Wiki: {{completed}} / {{total}} documents analyzed · {{deleted}} pending cleanup",
  'wiki.documents.batch': "This batch: {{done}} / {{total}} documents processed",
  'wiki.documents.search': "Search filename or relative path",
  'wiki.documents.allDirectories': "All directories",
  'wiki.documents.selectPending': "Select all pending documents",
  'wiki.documents.selectFailed': "Select failed documents",
  'wiki.documents.selectDirectory': "Select entire directory",
  'wiki.documents.selected': "{{count}} selected",
  'wiki.documents.selectFiltered': "Select all filtered ({{count}})",
  'wiki.documents.clear': "Clear selection",
  'wiki.documents.analyze': "Analyze selected ({{count}})",
  'wiki.documents.force': "Force reanalysis",
  'wiki.documents.cleanup': "Clean up selected deletions ({{count}})",
  'wiki.documents.syncOnly': "Sync documents only",
  'wiki.documents.syncStarted': "Syncing source documents without AI…",
  'wiki.documents.selectPage': "Select current page",
  'wiki.documents.path': "Relative path",
  'wiki.documents.state': "Analysis status",
  'wiki.documents.size': "Size",
  'wiki.documents.empty': "No matching documents",
  'wiki.documents.previous': "Previous",
  'wiki.documents.next': "Next",
  'wiki.documents.pagination': "Page {{page}} / {{pages}} · {{count}} documents",
  'wiki.documents.forceConfirm': "Force reanalysis of {{count}} documents?",
  'wiki.documents.forceHint': "Calls AI again without reusing previous analysis. Resuming this task still reuses its own checkpoints.",
  'wiki.documents.cleanupConfirm': "Clean up knowledge from {{count}} deleted documents?",
  'wiki.documents.cleanupHint': "Remove exclusively supported knowledge and stale references; preserve shared knowledge. Publishes a new version that can be rolled back.",
  'wiki.documents.started': "Submitted {{count}} documents. Completed documents with unchanged content are skipped.",
  'wiki.documents.notFound': "Source document no longer exists",
  'wiki.documents.status.all': "All statuses",
  'wiki.documents.status.pending-work': "Pending work",
  'wiki.documents.status.pending': "Not analyzed",
  'wiki.documents.status.changed': "Content changed",
  'wiki.documents.status.processing': "Analyzing",
  'wiki.documents.status.completed': "Completed",
  'wiki.documents.status.failed': "Failed",
  'wiki.documents.status.deleted': "Pending cleanup",
  'wiki.git.sourceHint': 'The source type is fixed at creation. Git documents are managed by the repository.',
  'wiki.git.uploadSource': 'Upload documents',
  'wiki.git.repoSource': 'Git repository',
  'wiki.git.repoUrl': 'Repository URL',
  'wiki.git.branch': 'Branch',
  'wiki.git.docsPath': 'Document directory',
  'wiki.git.docsPathHint': 'Relative path within the repository; leave empty for the repository root. Committed .md files are read recursively with their paths preserved, up to 5 MiB per file.',
  'wiki.git.credentialsHint': 'Private repositories use existing server Git credentials. Click Sync and analyze after creation.',
  'wiki.git.sync': 'Sync and analyze all pending documents',
  'wiki.git.fetching': 'Fetching Git repository',
  'wiki.git.activeCommit': 'Active version commit',
  'wiki.git.checkedCommit': 'Last checked commit',
  'wiki.git.notSynced': 'Not published yet',
  'wiki.git.unchanged': 'No document changes. Analysis was skipped and the active version is unchanged.',
  'wiki.git.stats': 'Documents {{total}} · Added {{added}} · Modified {{modified}} · Detected deletions {{deleted}} · Skipped {{skipped}} · Retried {{retried}} · Failed {{failed}}',
  'wiki.git.completed': 'Git sync completed: {{added}} added, {{modified}} modified, {{deleted}} deletions detected, {{retried}} retried, {{failed}} failed. Confirm cleanup in Original documents.',
  ...
  'wiki.version.history': 'Version History',
  'wiki.version.title': 'Wiki Version History',
  'wiki.version.empty': 'No build versions',
  'wiki.version.version': 'Version',
  'wiki.version.state': 'State',
  'wiki.version.pages': 'Pages',
  'wiki.version.time': 'Completed',
  'wiki.version.action': 'Action',
  'wiki.version.active': 'Active',
  'wiki.version.state.published': 'Published',
  'wiki.version.state.building': 'Building',
  'wiki.version.state.failed': 'Build failed',
  'wiki.version.rollback': 'Roll back to this version',
  'wiki.version.rollbackConfirm': 'Roll back to v{{version}}?',
  'wiki.version.rollbackDesc': 'This only switches the active version. No current or historical data will be deleted.',
  'wiki.version.rollbackSuccess': 'Rolled back to v{{version}}',
  ...
  'wiki.detail.uploaded.desc':
    'Original documents are saved. Select documents in Original documents and analyze them to use the knowledge in pages, graph, and search.',
  'wiki.detail.uploaded.ok': 'Select Documents',
  'wiki.detail.uploaded.cancel': 'Later',
  'wiki.detail.uploaded.later':
    'Documents saved. Select and analyze them in the Original documents tab when ready.',
