...
export const enUS = {
  ...
  'wiki.git.sync': 'Sync and analyze',
  ...
  'wiki.git.stats': 'Documents {{total}} · Added {{added}} · Modified {{modified}} · Deleted {{deleted}} · Skipped {{skipped}} · Retried {{retried}} · Failed {{failed}}',
  'wiki.git.completed': 'Git sync completed: {{added}} added, {{modified}} modified, {{deleted}} deleted, {{retried}} retried, {{failed}} failed.',
